...
class PlayerViewModel: NSObject, AVAudioPlayerDelegate {
    ...
    func setupAudio() {
        ...
        do {
            ...
            showAlert(alert: Alerts.AudioFileError, message: String(describing: error))
        }
    }
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        audioPlayerNode.scheduleFile(audioFile, at: nil) {
            ...
            self.stopTimer = Timer(timeInterval: delayInSeconds, target: self, selector: #selector(PlayerViewModel.stopAudio), userInfo: nil, repeats: false)
        ...
        do {
            ...
            showAlert(alert: Alerts.AudioEngineError, message: String(describing: error))
            return
        }
